# Generated by Powerlevel10k configuration wizard on 2019-12-02 at 15:51 EST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='turquoise2'
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='grey19'
  # Make the icon bold.
